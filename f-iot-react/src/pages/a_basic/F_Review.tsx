// React 스니펫: rfce(함수형 컴포넌트 생성 + export default 내보내기)
// cf) tsx파일 반드시 컴포넌트 형식 / HTML 요소를 반환
...
// - 재사용은 export(내보내기)와 import(갸져오기)를 통해 구현

// - 파일명이 반드시 대문자로 시작 (UpperCameCase)
// cf) 일반 함수(기능적)는  소문자로 시작 (lowerCameCase)
...
// 1) 단일 루트 노드
// : 최상단 루트 태그 존재
// - 최상단 형재 태그 있을 수 없음 (반드시 하나의 부모가 필요)
