...
class TaskLogger {
 ...
 deleteTask(taskId: number): void {
  // 현재의 tasks 배열을 순회하여 순회되는 요소의 id와 삭제하고자 하는 요소의 id(매개변수값)가
  // 일치하지 않는 요소만 새로운 배열에ㅣ 담아 tasks에 저장
...
const init = (): void => {
  ...
  const closeModalButton = document.getElementById('add-task-button');
