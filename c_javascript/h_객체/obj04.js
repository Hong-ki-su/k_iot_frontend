...
// : 대신 기존 객체를 복사(prothtype)해서 새로운 객체 생성 가능
// > 객체가 다른 객체를 복사해서 만들어지고
// 그 원본 객체를 프로토타입 이라고 부르는 구조
// 모든 객체들이 메서드와 속성을 상속받기 위한 템플릿을 프로토타입 객체를 가짐
...
class UpperCameCaseName {
  ...
  // 생성자 : 클래스명과 동일하지 않고 모든 생성자를 메서드명은 constructor
...
let human2 = new UpperCameCaseName('이지훈', 17,  '고등학생');
