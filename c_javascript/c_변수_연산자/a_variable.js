...
// 1) 변수 선언 방법: 변수종류 변수명;
let letVar; // Variable변수
var varVar; 

// 2) 변수 할당(대입) 방법: 변수명 = 데이터값;
letVar = 10;
varVar = 20;
...
// ? 호이스팅
// :인터프리터(코드를 읽는 기기)가 코드를 실행하기전 변수, 함수, 클래스 등의 
...
// letVar3 = 30; // 선언 전 초기화
// console.log(letVar3);
// 호이스팅이 되지만 실직적인 선언 문장을 읽기 전 호출이 불가

varVar3 = 40;
console.log(varVar3); // 호아스팅과 TDZ 접근 가능으로 
...
// !상수(constant)
// : 변하지 않는 수, 한 번 할당된 값 변경 X (재활당 불가)
// - 선언과 동시에 반드시 초기화
