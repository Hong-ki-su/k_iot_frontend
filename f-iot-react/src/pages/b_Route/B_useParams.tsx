...
// : 사용자 번호(user ID: 10) - 프론트엔드 화면을 10유저로 페이지로 출력

// cf) https://example.com/api/v1/users/10

//? useParams 사용 목적
// : URL에 따라 다른 내용을 보여주기 위함 
// - 하나의 컴포넌트(UI)에 여러 화면을 보여주는 리액트의 특성을 위함

// EX) ~/users: 모든 사용자 목록
// ~/users/1 : ID가 1인 사용자 정보
// ~/users/2 : ID가 2인 사용자 정보
// >> 주소를 각각 다르게 인식하려면, useParams로 /users/:Id 종의 :id값을 추출

//? 기본 사용법
// a태그 속성을 가진 요소로 화면 전환
