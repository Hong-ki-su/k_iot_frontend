...
const basketball = '농구';
 ...
 newLength = fruits.unshift('mango', 'orange'); // 시작 부분에 하나 이상의 요소 추가
 console.log(newLength);
 console.log(fruits);
 ...
 // >> 3번쨰 인자값이 있으면 추가로 인식
 console.log(fruits);
 fruits.splice(1, 0, 'Strawberry', 'Cocount');
 console.log(fruits);
