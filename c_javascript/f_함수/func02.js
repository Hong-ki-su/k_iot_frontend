...
//? 함수 명명 규칙: lowerCameCase 사용 + 동사 사용 권장
...
// 3) 화살표 함수
// : function 키워드 사용 없음 - 해당 키워드를 화살표(=>)로 대체 (간결한 작성), 함수명 사용 안됨
// > 호이스팅 적용이 안됨
// +) 무조건 익명 함수로 작성
// this가 일반 함수와 다르게 바인딩 됨
/*
변수종류 변수명 = (매개변수 나열) {
- 함수 기능 작성
- return 반환값; (선택적)
