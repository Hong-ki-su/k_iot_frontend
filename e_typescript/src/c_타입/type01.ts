...
// parameter' 매개 변수에는 암시적으로 'any' 형식이 포함됩니다.ts(7006)
...
let nullType: null = null; // 타입 주석으로 사용한 타입 강화 시 
nullType = null;

let nudefinedType: undefined;
// undefinedType = 'hello'
// undefinedType = 123;
