...
//? random 함수 정의: 0 부터 255까지의 랜덤 숫자 생성
...
//? HTML 요소를, 참조(가져오는)
//? 웹문서.선택자를 질문('선택자');
// > 제공한 선택자와 일치하는 문서 내 첫 번째 Element를 반환
...
// cf) on-키워드
// : 웹 이벤트 종류를 웹 문서의 요소에 연결시켜주는 키워드
...
bgButton.onclick = function() {
  ...
  // > JS에서는 스타일규칙을 lowerCameCase로 사용
  bgButton.computedStyleMap.backgroundColor = randomColor;
  bgButton.computedStyleMap.border = '10px solid black'; 
}

const textPara = document.querySelector("#keydown");
