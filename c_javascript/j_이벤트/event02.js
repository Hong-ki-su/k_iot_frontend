...
// > 매개변수 지정 - event, evt, 0e 등으로 명명 권장
...
// > addEventListener의 세 번째 인자를 true로 주어야 캡쳐링
...
child.addEventListener('click', (e) => {
  ...
  // 이벤트 버블링은 자식 > 부모로 진행
  // : 자식요소 이벤트객체. stopPropagation()을 사용하여 이벤트 전파 중지 
  e.stopPropagation();
});