...
//? 2.객체 메서드 안의 this
// : 객체의 변수에 활당되는 함수
// - 메서드 호출시 this는 해당 메서드를 호출한 객체에 바인딩
const myObject = {
  name: 'object',
  showThis: function() {
    console.log(this);
...
const person1 = new Person('홍기수');
const person2 = new Person('김채환');
...
const arrowObject = {
  ...
  showThis: () => {
    ...
    // >> 해당 화살표는 함수가 정의된 객체의 생성 스코프를 this로 가져옴
    console.log(this);
  }
}
...
//! cf) 객체 내부의 this는 
// 선언적함수, 함수 표현식 VS 화살표 함수의 this 바인딩 다름
// >> 현재의 객체값을 활용하기 위함이기 떄문에 선언적 함수, 함수 표현식 사용 권장